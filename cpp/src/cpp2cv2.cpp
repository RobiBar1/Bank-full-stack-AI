...
class PublicTransport
{
  public:
    ...
    static void print_count() { cout << "s_count: " << s_count << "\n"; }

  protected:
    int get_ID() { return m_license_plate; }
...
{
  public:
    Minibus() : m_numSeats(20) { cout << "Minibus::Ctor()\n"; }
...
{
  public:
    ArmyMinibus() { cout << "ArmyMinibus::Ctor()\n"; }
    ...
    ~ArmyMinibus() { cout << "ArmyMinibus::Dtor()\n"; }
...
class Taxi : public PublicTransport
{
  public:
    ...
    void display() { cout << "Taxi::display() ID:" << get_ID() << "\n"; }
...
{
  public:
    SpecialTaxi() { cout << "SpecialTaxi::Ctor()\n"; }
    ...
    ~SpecialTaxi() { cout << "SpecialTaxi::Dtor()\n"; }

    void display() { cout << "SpecialTaxi::display() ID:" << get_ID() << "\n"; }
...
void print_info(PublicTransport& a) { a.display(); }

void print_info() { PublicTransport::print_count(); }

void print_info(Minibus& m) { m.wash(3); }
...
void taxi_display(Taxi s) { s.display(); }
